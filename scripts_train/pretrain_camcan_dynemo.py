"""Pre-train DyNeMo on the full MEG CamCAN dataset
...
if __name__ == "__main__":
    ...
    BASE_DIR = "/well/woolrich/users/olt015/AnalyzeNTAD/results"
    ...
    training_data = data.Data(file_names, picks=["misc"], reject_by_annotation="omit", store_dir=tmp_dir, use_tfrecord=True)
    prepare_config = {
    ...
    init_history = model.random_subset_initialization(training_data, n_init=5, n_epochs=2, take=0.5)
