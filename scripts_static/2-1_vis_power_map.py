...
if __name__ == "__main__":
    ...
    power_an = data["power_map_an"]
    power_ap = data["power_map_ap"]
    print("Shape of AN power map: ", power_an.shape)
    print("Shape of AP power map: ", power_ap.shape)

    # Calculate group-level power maps
    gpower_an = np.mean(power_an, axis=0)
    gpower_ap = np.mean(power_ap, axis=0)
    gpower_diff = gpower_ap - gpower_an # amyloid positive vs. amyloid negative
